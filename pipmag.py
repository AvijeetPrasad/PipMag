...
# define a function that extracts the timestamp from a list of file names and returns the file name with the latest timestamp
    ...
    timestamp_dt_list = [datetime.strptime(timestamp, "%Y%m%d_%H%M%S") for timestamp in timestamp_list]
